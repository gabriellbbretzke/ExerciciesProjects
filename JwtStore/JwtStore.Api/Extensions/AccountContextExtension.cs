...
public static class AccountContextExtension
{
    ...
    public static void MapAccountEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("api/v1/users", async (
            ...
            IRequestHandler< JwtStore.Core.Contexts.AccountContext.UseCases.Create.Request, JwtStore.Core.Contexts.AccountContext.UseCases.Create.Response> handler
            ) =>
        {
        ...
        app.MapPost("api/v1/authenticate", async (
            ...
            IRequestHandler<JwtStore.Core.Contexts.AccountContext.UseCases.Authenticate.Request, JwtStore.Core.Contexts.AccountContext.UseCases.Authenticate.Response> handler
            ) =>
        {
            var result = await handler.Handle(request, new CancellationToken());
            if (!result.Success)
            ...
            .RequireAuthorization("Admin, Student"); //UM OU OUTRO PERFIL;
